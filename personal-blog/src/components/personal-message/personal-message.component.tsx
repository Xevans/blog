    ...
    return (
        <>
            ...
            <figure className="md:flex max-w-5xl bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-800">
                ...
                <img src="https://res.cloudinary.com/dn9rcml4g/image/upload/f_auto,q_auto/v1/blog-pics/link-dizzy" className="w-24 h-24 md:w-48 md:h-auto md:rounded-none rounded-full mx-auto object-cover"/>
