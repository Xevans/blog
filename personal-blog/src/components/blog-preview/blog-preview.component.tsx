...
function BlogPreview() {
    ...
    return (
        <>
            <section className="bg-white dark:bg-slate-800 px-6 py-10 mx-auto ">
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
                        <div>
                            <CloudinaryImage name="dev-image-1" width={1470} height={1470} definitions="object-cover object-center w-full h-64 rounded-lg lg:h-80" />
                        ...
                        <div>
                            <CloudinaryImage name="awakening-promo-1" width={765} height={526} definitions="object-cover object-center w-full h-64 rounded-lg lg:h-80" />
                        ...
                        <div>
                        <CloudinaryImage name="mern1" width={765} height={526} definitions="object-cover object-center w-full h-64 rounded-lg lg:h-80" />
